...
namespace Pos.Internals.UndoRedo.Collections.Generic
{
    public class UndoRedoDictionary<TKey, TValue> : Dictionary<TKey, TValue>, IUndoRedoMember
    {
        ...
        public UndoRedoDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) : base(dictionary, comparer)
        {
        }
        ...
        protected UndoRedoDictionary(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
        ...
        private delegate void OperationInvoker();

        private class ChangesList : List<Change<OperationInvoker>> 
        { 
