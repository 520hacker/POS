...
namespace Polenter.Serialization.Deserializing
{
    ...
    public sealed class ObjectFactory
    {
        ...
        public object CreateObject(Property property)
        {
            ...
            if (referenceTarget.Reference != null)
            {
                if (!referenceTarget.Reference.IsProcessed)
                {
                    ...
                    return this._objectCache[referenceTarget.Reference.Id];                    
                }
            }
            
            object value = this.createObjectCore(referenceTarget);
            if (value != null)
            {
                return value;
            }
        ...
        private object createObjectCore(ReferenceTargetProperty property)
        {
            ...
            {
                return this.createObjectFromMultidimensionalArrayProperty(multiDimensionalArrayProperty);
            }
            ...
            {
                return this.createObjectFromSingleDimensionalArrayProperty(singleDimensionalArrayProperty);
            }
            ...
            {
                return this.createObjectFromDictionaryProperty(dictionaryProperty);
            }
            ...
            {
                return this.createObjectFromCollectionProperty(collectionProperty);
            }
            ...
            {
                return this.createObjectFromComplexProperty(complexProperty);
            }
        ...
        private object createObjectFromComplexProperty(ComplexProperty property)
        {
            ...
            if (property.Reference != null)
            {
                ...
                this._objectCache.Add(property.Reference.Id, obj);
            }
            
            this.fillProperties(obj, property.Properties);
        ...
        private object createObjectFromCollectionProperty(CollectionProperty property)
        {
            ...
            if (property.Reference != null)
            {
                ...
                // have properties with references. Object must be cached to
                // resolve its references in the future.
                this._objectCache.Add(property.Reference.Id, collection);
            }
            
            // fill the properties
            this.fillProperties(collection, property.Properties);
            ...
            if (methodInfo != null)
            {
                ...
                if (parameters.Length == 1)
                {
                    ...
                    {
                        object value = this.CreateObject(item);
        ...
        private object createObjectFromDictionaryProperty(DictionaryProperty property)
        {
            ...
            if (property.Reference != null)
            {
                ...
                // have properties with references. Object must be cached to
                // resolve its references in the future.
                this._objectCache.Add(property.Reference.Id, dictionary);
            }
            
            // fill the properties
            this.fillProperties(dictionary, property.Properties);
            ...
            if (methodInfo != null)
            {
                ...
                if (parameters.Length == 2)
                {
                    ...
                    {
                        object keyValue = this.CreateObject(item.Key);
                        object valueValue = this.CreateObject(item.Value);
        ...
        private void fillProperties(object obj, IEnumerable<Property> properties)
        {
            foreach (Property property in properties)
            {
                ...
                object value = this.CreateObject(property);
                if (value == null)
                {
                    continue;
                }
                
                propertyInfo.SetValue(obj, value, this._emptyObjectArray);
            }
        }
        ...
        private object createObjectFromMultidimensionalArrayProperty(MultiDimensionalArrayProperty property)
        {
            ...
            {
                object value = this.CreateObject(item.Value);
                if (value != null)
                {
