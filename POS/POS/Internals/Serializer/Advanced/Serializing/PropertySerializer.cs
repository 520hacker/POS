...
namespace Polenter.Serialization.Advanced.Serializing
{
    ...
    public abstract class PropertySerializer : IPropertySerializer
    {
        ...
        protected void SerializeCore(PropertyTypeInfo<Property> property)
        {
            ...
            {
                this.SerializeNullProperty(new PropertyTypeInfo<NullProperty>(nullProperty, property.ExpectedPropertyType,
                    property.ValueType));
                return;
            }
            ...
            {
                this.SerializeSimpleProperty(new PropertyTypeInfo<SimpleProperty>(simpleProperty,
            ...
            {
                if (this.serializeReference(referenceTarget))
                {
                ...
                if (this.serializeReferenceTarget(new PropertyTypeInfo<ReferenceTargetProperty>(referenceTarget,
                    property.ExpectedPropertyType,
                    property.ValueType)))
                { 
                    return;
        ...
        private bool serializeReferenceTarget(PropertyTypeInfo<ReferenceTargetProperty> property)
        {
            ...
            if (multiDimensionalArrayProperty != null)
            {
                ...
                this.SerializeMultiDimensionalArrayProperty(
            ...
            if (singleDimensionalArrayProperty != null)
            {
                ...
                this.SerializeSingleDimensionalArrayProperty(
            ...
            if (dictionaryProperty != null)
            {
                ...
                this.SerializeDictionaryProperty(new PropertyTypeInfo<DictionaryProperty>(dictionaryProperty,
                    property.ExpectedPropertyType,
                    property.ValueType));
                return true;
            }
            ...
            if (collectionProperty != null)
            {
                ...
                this.SerializeCollectionProperty(new PropertyTypeInfo<CollectionProperty>(collectionProperty,
                    property.ExpectedPropertyType,
                    property.ValueType));
                return true;
            }
            ...
            if (complexProperty != null)
            {
                ...
                this.SerializeComplexProperty(new PropertyTypeInfo<ComplexProperty>(complexProperty,
                    property.ExpectedPropertyType,
                    property.ValueType));
                return true;
            }
