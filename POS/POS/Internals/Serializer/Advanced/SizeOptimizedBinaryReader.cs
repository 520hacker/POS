...
namespace Polenter.Serialization.Advanced
{
    ...
    public sealed class SizeOptimizedBinaryReader : IBinaryReader
    {
        ...
        {
            int index = BinaryReaderTools.ReadNumber(this._reader);
        ...
        public void Open(Stream stream)
        {
            ...
            // read names
            this._names.Clear();
            readHeader(this._reader, this._names, text => text);
            
            // read types
            this._types.Clear();
            readHeader(this._reader, this._types, this._typeNameConverter.ConvertToType);
        }
