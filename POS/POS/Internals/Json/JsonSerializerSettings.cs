...
namespace Lib.JSON
{
    ...
    public class JsonSerializerSettings
    {
        ...
        {
            this.ReferenceLoopHandling = DefaultReferenceLoopHandling;
            this.MissingMemberHandling = DefaultMissingMemberHandling;
            this.ObjectCreationHandling = DefaultObjectCreationHandling;
            this.NullValueHandling = DefaultNullValueHandling;
            this.DefaultValueHandling = DefaultDefaultValueHandling;
            this.PreserveReferencesHandling = DefaultPreserveReferencesHandling;
            this.TypeNameHandling = DefaultTypeNameHandling;
            this.TypeNameAssemblyFormat = DefaultTypeNameAssemblyFormat;
