...
namespace Lib.JSON.Utilities
{
    internal static class MiscellaneousUtils
    {
        ...
        {
            string newMessage = string.Format("{0}{1}{2}", message, Environment.NewLine, @"Actual value was {0}.".FormatWith(CultureInfo.InvariantCulture, actualValue));
        ...
        public static string ToString(object value)
        {
            ...
            return (value is string) ? string.Format("{0}{1}{2}", @"""", value.ToString(), @"""") : value.ToString();
        }
