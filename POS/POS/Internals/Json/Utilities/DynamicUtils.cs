    ...
    internal static class DynamicUtils
    {
      ...
      public const string CSharpAssemblyName = "Microsoft.CSharp, Version=2.0.5.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35";
        ...
        internal class NoThrowGetBinderMember : GetMemberBinder
        {
            ...
            {
                DynamicMetaObject retMetaObject = this._innerBinder.Bind(target, new DynamicMetaObject[] { });
        ...
        internal class NoThrowSetBinderMember : SetMemberBinder
        {
            ...
            {
                DynamicMetaObject retMetaObject = this._innerBinder.Bind(target, new DynamicMetaObject[] { value });
