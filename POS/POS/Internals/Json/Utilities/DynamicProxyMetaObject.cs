...
namespace Lib.JSON.Utilities
{
    internal sealed class DynamicProxyMetaObject<T> : DynamicMetaObject
    {
        ...
        {
            return this._proxy.GetType().GetMember(method, MemberTypes.Method, BindingFlags.Public | BindingFlags.Instance).Cast<MethodInfo>()
                       .Any(info =>
        ...
        {
            return this.IsOverridden("TryGetMember")
                   ? this.CallMethodWithResult("TryGetMember", binder, NoArgs, e => binder.FallbackGetMember(this, e))
                   : base.BindGetMember(binder);
        }

        public override DynamicMetaObject BindSetMember(SetMemberBinder binder, DynamicMetaObject value)
        {
            return this.IsOverridden("TrySetMember")
                   ? this.CallMethodReturnLast("TrySetMember", binder, GetArgs(value), e => binder.FallbackSetMember(this, value, e))
                   : base.BindSetMember(binder, value);
        }

        public override DynamicMetaObject BindDeleteMember(DeleteMemberBinder binder)
        {
            return this.IsOverridden("TryDeleteMember")
                   ? this.CallMethodNoResult("TryDeleteMember", binder, NoArgs, e => binder.FallbackDeleteMember(this, e))
                   : base.BindDeleteMember(binder);
        }

        public override DynamicMetaObject BindConvert(ConvertBinder binder)
        {
            return this.IsOverridden("TryConvert")
                   ? this.CallMethodWithResult("TryConvert", binder, NoArgs, e => binder.FallbackConvert(this, e))
        ...
        public override DynamicMetaObject BindInvokeMember(InvokeMemberBinder binder, DynamicMetaObject[] args)
        {
            ...
            DynamicMetaObject call = this.BuildCallMethodWithResult(
                "TryInvokeMember",
                binder,
                GetArgArray(args),
            ...
            return this._dontFallbackFirst ? call : fallback(call);
        }

        public override DynamicMetaObject BindCreateInstance(CreateInstanceBinder binder, DynamicMetaObject[] args)
        {
            return this.IsOverridden("TryCreateInstance")
                   ? this.CallMethodWithResult("TryCreateInstance", binder, GetArgArray(args), e => binder.FallbackCreateInstance(this, args, e))
                   : base.BindCreateInstance(binder, args);
        }

        public override DynamicMetaObject BindInvoke(InvokeBinder binder, DynamicMetaObject[] args)
        {
            return this.IsOverridden("TryInvoke")
                   ? this.CallMethodWithResult("TryInvoke", binder, GetArgArray(args), e => binder.FallbackInvoke(this, args, e))
        ...
        {
            return this.IsOverridden("TryUnaryOperation")
                   ? this.CallMethodWithResult("TryUnaryOperation", binder, NoArgs, e => binder.FallbackUnaryOperation(this, e))
        ...
        {
            return this.IsOverridden("TrySetIndex")
                   ? this.CallMethodReturnLast("TrySetIndex", binder, GetArgArray(indexes, value), e => binder.FallbackSetIndex(this, indexes, value, e))
                   : base.BindSetIndex(binder, indexes, value);
        }

        public override DynamicMetaObject BindDeleteIndex(DeleteIndexBinder binder, DynamicMetaObject[] indexes)
        {
            return this.IsOverridden("TryDeleteIndex")
                   ? this.CallMethodNoResult("TryDeleteIndex", binder, GetArgArray(indexes), e => binder.FallbackDeleteIndex(this, indexes, e))
        ...
        private DynamicMetaObject CallMethodWithResult(string methodName, DynamicMetaObjectBinder binder, Expression[] args, Fallback fallback, Fallback fallbackInvoke = null)
        {
            ...
            DynamicMetaObject callDynamic = this.BuildCallMethodWithResult(methodName, binder, args, fallbackResult, fallbackInvoke);
            ...
            return this._dontFallbackFirst ? callDynamic : fallback(callDynamic);
        }
        ...
        private DynamicMetaObject BuildCallMethodWithResult(string methodName, DynamicMetaObjectBinder binder, Expression[] args, DynamicMetaObject fallbackResult, Fallback fallbackInvoke)
        {
            ...
            callArgs.Add(Expression.Convert(this.Expression, typeof(T)));
            ...
            DynamicMetaObject callDynamic = new DynamicMetaObject(
                Expression.Block(
                    ...
                    Expression.Condition(
                        Expression.Call(
                            Expression.Constant(this._proxy),
                            typeof(DynamicProxy<T>).GetMethod(methodName),
                            callArgs),
                        resultMetaObject.Expression,
                        fallbackResult.Expression,
                        binder.ReturnType)),
                this.GetRestrictions().Merge(resultMetaObject.Restrictions).Merge(fallbackResult.Restrictions));
            ...
            DynamicMetaObject callDynamic = new DynamicMetaObject(
                Expression.Block(
                    ...
                    Expression.Condition(
                        ...
                        fallbackResult.Expression,
                        typeof(object))),
                this.GetRestrictions().Merge(fallbackResult.Restrictions));
        ...
        {
            return (this.Value == null && this.HasValue)
                   ? BindingRestrictions.GetInstanceRestriction(this.Expression, null)
