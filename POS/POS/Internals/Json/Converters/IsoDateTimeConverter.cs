    ...
    public class IsoDateTimeConverter : DateTimeConverterBase
    {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            else if (value is DateTimeOffset)
            {
                ...
                text = dateTimeOffset.ToString(this._dateTimeFormat ?? DefaultDateTimeFormat, this.Culture);
            }
            #endif
            else
            {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            if (t == typeof(DateTimeOffset))
            {
                ...
                {
                    return DateTimeOffset.ParseExact(dateText, this._dateTimeFormat, this.Culture, this._dateTimeStyles);
                }
                else
                {
                    return DateTimeOffset.Parse(dateText, this.Culture, this._dateTimeStyles);
                }
            }
            #endif
