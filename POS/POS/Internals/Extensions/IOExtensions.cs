...
namespace Pos.Internals.Extensions
{
    ...
    public static class IOExtensions
    {
        ...
        public static string FileSizeFormatted(this int fileSize, int decimals)
        {
            return Convert.ToInt64(fileSize).FileSizeFormatted(decimals);
        }
        ...
        /// <returns>The resulting string.</returns>
        public static string FileSizeFormatted(this FileInfo fileInfo, int decimals)
        {
            long fileSize = fileInfo.Length;

            return fileSize.FileSizeFormatted(decimals);
        }
