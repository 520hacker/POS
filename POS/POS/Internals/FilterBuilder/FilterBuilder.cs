...
namespace POS.Internals.FilterBuilder
{
    ...
    public class FilterBuilder
    {
        ...
        public ImageSize FileTypeIconSize
        {
            get
            {
                return SystemFileType.currentSize;
            }
            set
            {
                SystemFileType.currentSize = value;
            }
        }
        ...
        public void Add(Filters filter)
        {
            ...
            this.sFilters.Add(Helpers.ReturnFilterAsString(filter));
        }
        ...
        public void Add(Filters[] filters)
        {
            ...
            {
                this.sFilters.Add(Helpers.ReturnFilterAsString(item));
            }
        }
        ...
        public void Add(string extension, bool plural = true)
        {
            ...
            extension = extension.StartsWith(".") == false ? string.Format(".{0}", extension) : extension;
            
            //Try to get the system file type desription
            string description = "";
            try
            {
                description = this.GetSystemFileTypeDescription(extension);
            }
            catch (Exception)
            {
                description = "";
            ...
            if (plural)
            {
                ...
                description = description.EndsWith("s") == false ? string.Format("{0}s", description) : description;
            }
            ...
            //properly
            string s = string.Format("{0} (*.{1})|*.{2}", description.Trim(), ext, ext);
        ...
        public void Add(FilterGroup @group)
        {
            ...
            this.sFilters.Add(@group.GetFilterString());
        }
        ...
        public void Remove(Filters filter)
        {
            ...
            {
                this.sFilters.Remove(Helpers.ReturnFilterAsString(filter));
            }
        }
        ...
        public void Remove(string extension)
        {
            ...
            string description1 = description.EndsWith("s") == false ? string.Format("{0}s", description) : description;
            ...
            //Make the filter string by combining the description and extension
            //properly
            string s = string.Format("{0} (*.{1})|*.{2}", description1.Trim(), ext, ext);
            
            string s2 = string.Format("{0} (*.{1})|*.{2}", description1.Trim(), ext, ext);
            
            //Remove filter (plural)
            if (this.sFilters.Contains(s))
            {
                this.sFilters.Remove(s);
                return;
            }
            
            //Remove filter
            if (this.sFilters.Contains(s2))
            {
                this.sFilters.Remove(s2);
                return;
            }
        }
        ...
        public void Remove(string description, string extension)
        {
            ...
            //Check if list contains the filter, if so remove it
            if (this.Contains(description.Trim(), ext))
            {
                this.sFilters.Remove(s);
            }
        }
        ...
        public void Remove(Filters[] filter)
        {
            ...
            foreach (Filters item in filter)
            {
                ...
                {
                    this.sFilters.Remove(Helpers.ReturnFilterAsString(item));
                }
            }
        }
        ...
        public bool Contains(Filters filter)
        {
            ...
            return this.sFilters.Contains(Helpers.ReturnFilterAsString(filter));
        }
        ...
        public bool Contains(string description, string extension)
        {
            ...
            //Check the filter and return boolean
            return this.sFilters.Contains(s);
        }
        ...
        public int GetFilterIndex(Filters filter)
        {
            ...
            return (this.sFilters.IndexOf(Helpers.ReturnFilterAsString(filter)) > -1)
                   ? (this.sFilters.IndexOf(Helpers.ReturnFilterAsString(filter)) + 1)
                   : 1;
        }
        ...
        {
            //Return the index of the filter + 1 (1 based)
            return (this.sFilters.IndexOf(filter) > -1) ? (this.sFilters.IndexOf(filter) + 1) : 1;
        }
        ...
        public string GetFirstItem()
        {
            ...
            return this.sFilters.Count > 0 ? this.sFilters[0] : string.Empty;
        }
        ...
        {
            //Return the first item of the list
            return this.sFilters.Count > 0 ? this.sFilters[this.sFilters.Count - 1] : string.Empty;
        }
        ...
        public string GetSystemFileTypeDescription(Filters filter)
        {
            ...
            ext = ext.StartsWith(".") == false ? string.Format(".{0}", ext) : ext;
